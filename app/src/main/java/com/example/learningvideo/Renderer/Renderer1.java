...
public class Renderer1 implements IRenderer, TextureView.SurfaceTextureListener{
    ...
    public void render(Message msg) {
        ...
        GLES20.glBindTexture(mFrameProcessorList.get(mFrameProcessorList.size()-1).getOutTextureType(), mFrameProcessorList.get(mFrameProcessorList.size()-1).getOutputTexture());
    ...
    public void setup(int width, int height) {
        ...
        String outTexType = mFrameProcessorList.get(mFrameProcessorList.size()-1).getOutTextureType() == GLES20.GL_TEXTURE_2D ? "sampler2D" : "samplerExternalOES";
    ...
    public EGLResources getEGLResource() {
        return new EGLResources(false)
                ...
                .setTexture(mFrameProcessorList.get(mFrameProcessorList.size()-1).getOutputTexture());
    }
